...
const D = {
  brand: 'TOTOPEDIA',
  domain: 'totopediawap.com',
  logo: 'https://ik.imagekit.io/md2fquuug/toped_pp.png',
  linkLogin: 'https://loginwap.gelapsekali.com/toped',
  linkDaftar: 'https://daftarwap.gelapsekali.com/toped',
  amphtml: 'totopediawap.com',
};
...
const faqs = [
  { q: 'Bagaimana cara login TOTOPEDIA?', a: 'Kunjungi halaman login resmi di situs resmi TOTOPEDIA, masukkan username dan password, lalu klik Login.' },
  { q: 'Apakah TOTOPEDIA aman?', a: 'Ya, kami menggunakan enkripsi SSL 256-bit dan proteksi keamanan berlapis tingkat enterprise.' },
  { q: 'Bisa akses dari smartphone?', a: 'Tentu, TOTOPEDIA dioptimalkan untuk semua perangkat mobile dengan tampilan responsif.' },
...
export default function Home() {
  ...
  return (
    <>
      <Head>
        <title>TOTOPEDIA | Login Resmi Hari Ini » Ensiklopedia Lengkap Para Pemenang</title>
        <meta name="description" content="Akses TOTOPEDIA dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <link rel="icon" href={D.logo} />
        <link rel="canonical" href={'https://' + D.domain + '/'} />
        <link rel="amphtml" href={'https://' + D.domain + '/amp/'} />
        <meta property="og:title" content="TOTOPEDIA | Login Resmi Hari Ini » Ensiklopedia Lengkap Para Pemenang" />
        <meta property="og:description" content="Akses TOTOPEDIA dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
        <meta property="og:image" content={D.logo} />
        <meta property="og:url" content={'https://' + D.domain} />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary" />
        <meta name="twitter:title" content="TOTOPEDIA | Login Resmi Hari Ini » Ensiklopedia Lengkap Para Pemenang" />
        <meta name="twitter:description" content="Akses TOTOPEDIA dengan aman dan cepat. Server premium uptime 99.9%, proteksi data berlapis, dan navigasi intuitif untuk semua pengguna." />
      ...
      <style jsx global>{`
        :root{--bg:#0d1b2a;--bg2:#1b2838;--card:#1f3044;--primary:#c9a227;--primary2:#a68820;--accent:#e8c84a;--text:#d4d8dc;--muted:#8899aa;--border:rgba(201,162,39,.1);--r:2px}
        *{box-sizing:border-box;margin:0;padding:0}html{scroll-behavior:smooth}
        body{font-family:'Libre Baskerville',sans-serif;background:var(--bg);color:var(--text);line-height:1.7;overflow-x:hidden}
        a{color:inherit;text-decoration:none}img{max-width:100%;display:block}
        .C{max-width:1140px;margin:0 auto;padding:0 20px}
        header{position:sticky;top:0;z-index:50;background:#0d1b2ae8;backdrop-filter:blur(14px);border-bottom:1px solid var(--border)}
        ...
        .bp{background:var(--primary);color:#0d1b2a;box-shadow:0 4px 16px #c9a22735}
        .bp:hover{background:var(--primary2);transform:translateY(-2px);box-shadow:0 6px 24px #c9a22750}
        ...
        .badge{display:inline-flex;align-items:center;gap:8px;padding:6px 16px;border:1px solid var(--border);border-radius:99px;font-size:12px;color:var(--primary);background:#c9a22710;margin-bottom:20px;font-weight:600}
        ...
        .bnr-card:hover{transform:translateY(-3px);box-shadow:0 8px 24px #c9a22720}
        ...
        .sh .tg{display:inline-block;padding:5px 14px;border:1px solid var(--border);border-radius:var(--r);font-size:11px;color:var(--primary);background:#c9a22708;margin-bottom:10px;font-weight:700;text-transform:uppercase;letter-spacing:1px}
        ...
        .fc:hover{transform:translateY(-4px);border-color:var(--primary);box-shadow:0 10px 30px #c9a22715}
        .fc .ic{width:48px;height:48px;border-radius:var(--r);background:#c9a22712;display:flex;align-items:center;justify-content:center;font-size:22px;margin-bottom:12px}
        ...
        .step .nm{width:46px;height:46px;border-radius:50%;background:var(--primary);color:#0d1b2a;display:flex;align-items:center;justify-content:center;font-weight:800;font-size:16px;margin:0 auto 10px}
        ...
        .cta{background:var(--primary);border-radius:var(--r);padding:48px 28px;text-align:center;color:#0d1b2a}
        ...
        .hero{background:linear-gradient(180deg,#0d1b2a,#1b2838);border-bottom:3px solid #c9a227}.hero h1{font-family:'Libre Baskerville',serif}.sh h2{font-family:'Libre Baskerville',serif}.fc{border-top:2px solid var(--primary)}footer{background:#060d14;border-top:2px solid #c9a227}
      `}</style>
      ...
      <main>
        <section className="hero"><div className="C">
          ...
          <h1>TOTOPEDIA | Login Resmi Hari Ini » Ensiklopedia Lengkap Para Pemenang</h1>
          <p className="ld">TOTOPEDIA adalah platform terpercaya dengan akses super cepat, keamanan tingkat tinggi, dan link alternatif yang selalu aktif 24 jam. Daftar gratis sekarang.</p>
          <div className="hb">
        ...
        <section className="sec" id="tentang"><div className="C">
          ...
          <div className="art">
            <p>TOTOPEDIA hadir di situs resmi TOTOPEDIA dengan standar profesionalisme dan keamanan tertinggi. Sebagaimana kantor hukum terpercaya menjunjung tinggi kerahasiaan klien, TOTOPEDIA berkomitmen melindungi setiap data pengguna dengan enkripsi SSL 256-bit dan proteksi keamanan berlapis. Integritas dan kepercayaan adalah fondasi utama layanan kami.</p>
            <p>Platform resmi TOTOPEDIA di situs resmi TOTOPEDIA dirancang dengan presisi dan ketelitian, memastikan setiap proses login dan registrasi berjalan sesuai prosedur yang aman. Infrastruktur server enterprise-grade dengan uptime 99,9% menjamin ketersediaan layanan tanpa kompromi. Tersedia multiple link alternatif resmi yang terverifikasi, dan dukungan legal tim support profesional 24 jam penuh.</p>
          </div>
        </div></section>
        ...
        <section className="bnr"><div className="C">
          <div className="bnr-grid">
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1589829545856-d10d557cf95f?w=720&h=280&fit=crop" alt="TOTOPEDIA - Promo 1" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1505664194779-8beaceb93744?w=720&h=280&fit=crop" alt="TOTOPEDIA - Promo 2" loading="lazy" /></a>
            <a href={D.linkDaftar} className="bnr-card"><img src="https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=720&h=280&fit=crop" alt="TOTOPEDIA - Promo 3" loading="lazy" /></a>
          </div>
        </div></section>
